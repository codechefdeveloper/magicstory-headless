        ...
        <div className="p-8 md:p-14 flex flex-col justify-center text-white">
          ...
          <div>
            <button
              ...
              className="inline-flex items-center gap-2 bg-red-600 px-6 py-3 rounded-full font-semibold transition-all duration-300 hover:bg-red-700 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
            >
               {buttonLabel}
              <svg
                stroke="currentColor"
